...
#OOB RMSE
#train_rmse <- sqrt(gaitBag$mse[length(gaitBag$mse)])
#1.002981

#Train RMSE
#train_pred <- predict(gaitBag, newdata = subset(gait_train_df, select = -TUG.Time))
#train_rmse <- sqrt(mean((train_pred - gait_train_df$Gait.Time)^2))
#0.3991606
